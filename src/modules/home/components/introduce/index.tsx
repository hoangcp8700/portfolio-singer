    ...
    <Container>
      <div className='relative bg-white overflow-hidden md:min-h-screen'>
        ...
        <div className='flex flex-col gap-y-20 md:gap-y-10 mt-4 md:mt-10'>
          ...
          <Card className='before:left-0'>
            Không chỉ dừng lại ở đó, tôi đã tham gia và xuất sắc đạt giải 3 tại chương trình <b>Thần Tượng Tương Lai</b>{' '}
            và <b>Ai Sẽ Thành Sao Nhi</b>. Điều này chứng minh tôi không chỉ có giọng hát mạnh mẽ mà còn có khả năng
            biểu diễn đỉnh cao trên sân khấu.
          </Card>

          <Card className='before:right-0 ml-auto text-right'>
            Đối với tôi, âm nhạc không chỉ là sự đam mê, mà còn là cách tôi thể hiện bản thân và kết nối với mọi người.
            Vi thế, tôi còn góp mặt trong các <b>gameshow</b> truyền hình nổi tiếng, tôi luôn sẵn sàng đối mặt với thử
            thách và tạo ra những trải nghiệm đáng nhớ.
          </Card>

          <Card className='before:left-0'>
            <b>Hiện tại, kênh Tiktok của tôi đã đạt hơn 1,5 triệu Followers và hơn 30 triệu lượt thích</b>, đặc biệt
            những video ca hát của tôi thường xuyên đạt được hàng triệu lượt xem và được nhiều trang báo mạng chia sẻ và
            lên xu hướng.
          </Card>
        </div>
      </div>
