...
const Introduce: React.FC = () => {
  return (
    <div className='relative bg-white overflow-hidden'>
      <div className='absolute flex flex-col justify-center z-[1] right-[8%] top-[20%]'>
        <HeadingStyled
        ...
        <div className='flex flex-col-reverse md:flex-row flex-wrap items-center gap-4 justify-center mt-2 md:mt-4'>
          {info?.careers?.map((el) => (
